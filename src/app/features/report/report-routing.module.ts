...
import { ReportProfessorValidationComponent } from '../professor/components/report-professor-validation/report-professor-validation.component';
...
const routes: Routes = [
  ...
  { path :'supervise' , component : ReportProfessorValidationComponent,canActivate : [ProfGuard]},
